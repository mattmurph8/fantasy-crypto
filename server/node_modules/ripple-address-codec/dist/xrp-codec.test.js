...
makeEncodeDecodeTest(api.encodeAccountID, api.decodeAccountID, 'rJrRMgiRgrU6hDF4pgu5DXQdWyPbY35ErN', 'BA8E78626EE42C41B46D46C3048DF3A1C3C87072');
makeEncodeDecodeTest(api.encodeNodePublic, api.decodeNodePublic, 'n9MXXueo837zYH36DvMc13BwHcqtfAWNJY5czWVbp7uYTj7x17TH', '0388E5BA87A000CB807240DF8C848EB0B5FFA5C8E5A521BC8E105C0F0A44217828');
...
describe('encodeAccountID', function () {
    ...
    test('unexpected length should throw', function () {
        ...
        }).toThrow('unexpected_payload_length: bytes.length does not match expectedLength');
    });
});
...
//# sourceMappingURL=xrp-codec.test.js.map